...
@section('content')
	...
	background: url({{ asset('assets') }}/images/web/home-slider-1.png) no-repeat;">
        <div class="row mx-5">
            <div class="col-md-12">
                <div class="block">
                    <h2 class="animated fadeInUp text-left">EMPOWERING YOUR <br> <span
                            style="font-weight: 900; font-size: 72px;line-height: 65px;">DIGITAL TRANSFORMATION</span>
                    </h2>
                </div>
            </div>
        </div>
    ...
    <section class="about section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="block">
                        <img src="{{ asset('assets') }}/images/wrapper-img.png" alt="Img">
                    </div>
                </div><!-- .col-md-5 close -->
            </div>
        </div>
                    ...
                    <div class="testimonial-carousel text-center">
                        <div class="testimonial-slider owl-carousel">
                            <div>
                                ...
                                <div class="user">
                                    <img src="{{ asset('assets') }}/images/item-img1.jpg" alt="Pepole">
